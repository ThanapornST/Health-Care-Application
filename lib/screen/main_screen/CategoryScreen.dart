...
import 'package:healthcares/data/dummy_category.dart';
import 'package:healthcares/screen/sub_screen/BeverageMenu.dart';
import 'package:healthcares/screen/sub_screen/DessertMenu.dart';
import 'package:healthcares/screen/sub_screen/FruitMenu.dart';
import 'package:healthcares/screen/sub_screen/MainManu.dart';
...
class _CategoryScreenState extends State<CategoryScreen> {
  void _selectCategory(BuildContext context, String categoryId) {
    final filteredMeals = dummyMeals
     ...
     // ทำการแสดงผลหรือเรียกใช้ข้อมูล filteredMeals 
    if (categoryId == 'c1') {
      Navigator.push(
        context,
